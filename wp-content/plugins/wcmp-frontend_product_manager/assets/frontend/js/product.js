    ...
    return {
        ...
        init: function ( ) {
            $( '#woocommerce-product-data' )
                ...
                .bind( 'wcmp_after_save_attribute_triggered', this.afterSaveAttributeTrigger )
                ;
            $( '.add-product-single' )
                .on( 'click', '.notice-wrapper button.notice-dismiss', this.dismissNotice );
            //save
            $( '#wcmp-afm-add-product' ).on( 'click', '#afm_product_submit, #afm_product_draft', this.saveProduct.bind( this ) );
...
//            } );
            ...
            return {
                ...
                addAttribute: function ( e ) {
                    ...
                    if ( attribute || wcmp_advance_product_params.custom_attribute == "1" ) {
                        ...
                        var data = {
                            action: 'wcmp_afm_add_product_attribute',
                            taxonomy: attribute,
                            i: size,
                ...
                saveAttribute: function ( e ) {
                    ...
                    var data = {
                        ...
                        action: 'wcmp_afm_save_attributes',
        ...
        saveProduct: function ( e ) {
            $( 'form#wcmp-afm-add-product' ).trigger( 'before_product_save' );
            var status = ( e.target.id === 'afm_product_submit' ) ? 'publish' : ( e.target.id === 'afm_product_draft' ) ? 'draft' : '';
