 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce-bookings/emails/vendor-new-booking.php
 *
...
echo wp_kses_post( make_clickable( sprintf( __( 'You can view and edit this booking in the dashboard here: %s', 'woocommerce-bookings' ), esc_url( wcmp_get_vendor_dashboard_endpoint_url( 'bookings', $booking->get_id() ) ) ) ) );
?>
</p>
