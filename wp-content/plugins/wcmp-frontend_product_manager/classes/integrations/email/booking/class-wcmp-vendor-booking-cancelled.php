 ...
 *
 * @class   WC_Email_Vendor_Booking_Cancelled
 * @extends WC_Email
 */
class WC_Email_Vendor_Booking_Cancelled extends WC_Email {

	/**
	 * Constructor
	 */
	public function __construct() {
		$this->id             = 'vendor_booking_cancelled';
		$this->title          = __( 'Vendor Booking Cancelled', 'woocommerce-bookings' );
		...
		$this->template_html  = 'booking/emails/vendor-booking-cancelled.php';
		$this->template_plain = 'booking/emails/plain/vendor-booking-cancelled.php';
