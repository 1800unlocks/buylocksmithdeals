     ...
     */
     ...
     public function output() {
        ...
        $appointments_params = array(
            ...
            'empty_table'            => esc_js( __( 'No appointments found!', WCMp_AFM_TEXT_DOMAIN ) ),
            'processing'             => esc_js( __( 'Processing...', WCMp_AFM_TEXT_DOMAIN ) ),
            'info'                   => esc_js( __( 'Showing _START_ to _END_ of _TOTAL_ appointments', WCMp_AFM_TEXT_DOMAIN ) ),
            'info_empty'             => esc_js( __( 'Showing 0 to 0 of 0 appointments', WCMp_AFM_TEXT_DOMAIN ) ),
            'length_menu'            => esc_js( __( 'Number of rows _MENU_', WCMp_AFM_TEXT_DOMAIN ) ),
            'zero_records'           => esc_js( __( 'No matching appointments found', WCMp_AFM_TEXT_DOMAIN ) ),
