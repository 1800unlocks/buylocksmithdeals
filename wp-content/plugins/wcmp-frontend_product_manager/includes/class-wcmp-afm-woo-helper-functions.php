...
/**
 * WCMp_AFM_Woo_Helper_Functions setup
...
final class WCMp_AFM_Woo_Helper_Functions {

    /**
     * The single instance of the class.
     *
     * @var WCMp_AFM_Woo_Helper_Functions
     * @since 3.0.0
     */
     ...
     * @return array
     */
    public function get_posted_availability() {
        $availability = array();
     ...
     *
     */
    public function auction_history( $product_id, $datefrom = FALSE, $user_id = FALSE ) {
        global $wpdb;
        $wheredatefrom = '';
...
if ( ! function_exists( 'afm_woo' ) ) {

    function afm_woo() {
        return WCMp_AFM_Woo_Helper_Functions::instance();
    }
