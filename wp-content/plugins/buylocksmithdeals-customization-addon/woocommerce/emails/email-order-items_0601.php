		...
		wc_display_item_meta(
			...
			array(
               ...
               // print_r($item);
                ...
                ?>
                <a href="<?php echo $fb_url; ?>" target="_blank"><img src="<?php echo $fb_icon; ?>" height="40" width="40"></a>
                <a href="<?php echo $twitter_url; ?>" target="_blank" ><img src="<?php echo $twitter_icon; ?>" height="40" width="40"></a>
                <a href="<?php echo $linkedin_url; ?>" target="_blank" ><img src="<?php echo $linkedin_icon; ?>" height="40" width="40"></a>
                  <?php          
		// allow other plugins to add additional product information here.
