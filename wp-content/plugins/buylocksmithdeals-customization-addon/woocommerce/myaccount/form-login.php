...
<?php if (get_option('woocommerce_enable_myaccount_registration') === 'yes') : ?>
    ...
    <div class="col2-set" id="customer_login">
        ...
        <?php endif; ?>
		<?php if($myaccount_page_id==$current_page_id){ ?>
			<h2><?php esc_html_e('Customer Login', 'woocommerce'); ?></h2>
		<?php }
		else{ ?>
			<h2><?php esc_html_e('Locksmith Login', 'woocommerce'); ?></h2>
		<?php }	?>
        ...
        <div class="col-2">
			<?php if($myaccount_page_id==$current_page_id){ ?>
			<h2><?php esc_html_e('Customer Register', 'woocommerce'); ?></h2>
		<?php }
		else{ ?>
			<h2><?php esc_html_e('Locksmith Register', 'woocommerce'); ?></h2>
		<?php }	?>
