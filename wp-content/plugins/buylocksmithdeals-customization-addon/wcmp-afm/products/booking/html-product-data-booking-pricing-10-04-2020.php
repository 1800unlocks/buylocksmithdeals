...
$frontend_script_path = '/wp-content/plugins/'.BUYLOCKSMITH_DEALS_BASE_FOLDER_NAME . '/wcmp-afm/assets/';
wp_enqueue_script('select2_js_wcfm', $frontend_script_path . 'select2/select2.js', array('jquery'), '', true);
wp_enqueue_style('select2_css_wcfm', $frontend_script_path . 'select2/select2.css', array(), '');
