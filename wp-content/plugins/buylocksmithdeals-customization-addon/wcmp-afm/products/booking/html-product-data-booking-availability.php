        ...
        <div class="form-group-row"> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <span class="form-text"><span class='_wc_booking_buffer_period_unit'></span><?php esc_html_e( 'hours between bookings', 'woocommerce-bookings' ); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9">
                    ...
                    <span>By default buffer period applies forward into the future of a booking. Enabling this option will apply adjacently (before and after Bookings)</span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group _wc_booking_last_block_time_field">
                <label class="control-label col-sm-3 col-md-3" for="_wc_booking_last_block_time"><?php esc_html_e( 'last block ends at...', 'woocommerce-bookings' ); ?></label>
                <div class="col-md-6 col-sm-9">
                    <input type="time" class="form-control" id="_wc_booking_last_block_time" name="_wc_booking_last_block_time" value="<?php echo $wc_booking_last_block_time; ?>" placeholder="HH:MM">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3 col-md-3" for="_wc_booking_has_restricted_days">
                    <?php esc_html_e( 'Which days do you want this deal available?', 'woocommerce-bookings' ); ?>
