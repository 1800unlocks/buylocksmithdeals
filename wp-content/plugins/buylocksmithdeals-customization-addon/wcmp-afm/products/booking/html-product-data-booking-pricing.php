...
inclusive of any applicable taxes.</small></span> 
		...
		<div class="form-group-row deal_pricing"> 
		<h2>In-Shop Pricing For Customer</h2>
		<span><small>If the customer chooses to do the service at your location, you can choose to offer different pricing. For in-shop pricing, we will not charge the labor price, just the price to rekey the cylinders. What is included in the deal will not change, only the price. Depending on what customer selects, the system will calculate only that amount.</small></span>
           
            <?php // do_action( 'afm_bookings_after_booking_base_cost', $id ); ?>
            <div class="form-group">
                <label class="control-label col-sm-3 col-md-3" for="_wc_booking_in_shop_pricing_cost"><?php echo __( 'In-Shop Standard Lock Rekeying Price', 'woocommerce-bookings' ) . ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
                <div class="col-md-6 col-sm-9">
				<?php 
					$_wc_booking_in_shop_pricing_cost= get_post_meta($post_id, '_wc_booking_in_shop_pricing_cost', true); 
				?>
                    <input type="number" min="0" step=".01" id="_wc_booking_in_shop_pricing_cost" name="_wc_booking_in_shop_pricing_cost" value="<?php echo $_wc_booking_in_shop_pricing_cost; ?>" class="form-control">
                </div>
            </div>
            <?php do_action( 'afm_bookings_after_booking_block_cost', $id ); ?>
            <div class="form-group">
                <label class="control-label col-sm-3 col-md-3" for="_wc_display_cost"><?php echo __( 'In-Shop Standard Key Duplication Price:', 'woocommerce-bookings' ) . ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
                <div class="col-md-6 col-sm-9">
				<?php 
					$_wc_in_shop_key_duplication_price_cost= get_post_meta($post_id, '_wc_in_shop_key_duplication_price_cost', true); 
				?>
                    <input type="number" min="0" step=".01" id="_wc_in_shop_key_duplication_price_cost" name="_wc_in_shop_key_duplication_price_cost" value="<?php echo $_wc_in_shop_key_duplication_price_cost; ?>" class="form-control">
                </div>
            </div>
			<?php do_action( 'afm_bookings_after_display_cost', $id ); ?>
        </div>
...
inclusive of any applicable taxes.</small></span> 
			...
			<?php } if($is_in_shop_pricing_cp == 'yes'){ 
				...
				<!-- In-Shop Pricing For Customer -->
				<div class="form-group-row"> 
					<h2>In-Shop Pricing For Customer</h2>
					<span><small>If the customer chooses to do the service at your location, you can choose to offer different pricing. For in-shop pricing, we will not charge the labor price, just the price to cut and program the keys. What is included in the deal will not change, only the price. Depending on what customer selects, the system will calculate only that amount.
					</small></span> 
					<div class="form-group">
						<label class="control-label col-sm-3 col-md-3" for="inshop_double_sided_car_key_price"><?php echo __( 'In-Shop Double-Sided Car Key Cutting Price ('.get_woocommerce_currency_symbol().')', 'woocommerce-bookings' ); ?></label>
						<div class="col-md-6 col-sm-9">
							<input type="number" min="0" step="1" id="inshop_double_sided_car_key_price" name="inshop_double_sided_car_key_price" value="<?php if(isset($inshop_double_sided_car_key_price) && !empty($inshop_double_sided_car_key_price)){ echo $inshop_double_sided_car_key_price; } ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3 col-md-3" for="inshop_high_security_car_key_price"><?php echo __( 'In-Shop High-Security Car Key Cutting Price ('.get_woocommerce_currency_symbol().')', 'woocommerce-bookings' ); ?></label>
						<div class="col-md-6 col-sm-9">
							<input type="number" min="0" step="1" id="inshop_high_security_car_key_price" name="inshop_high_security_car_key_price" value="<?php if(isset($inshop_high_security_car_key_price) && !empty($inshop_high_security_car_key_price)){ echo $inshop_high_security_car_key_price; } ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3 col-md-3" for="inshop_tibbe_car_key_price"><?php echo __( 'In-Shop Tibbe Car Key Cutting Price ('.get_woocommerce_currency_symbol().')', 'woocommerce-bookings' ); ?></label>
						<div class="col-md-6 col-sm-9">
							<input type="number" min="0" step="1" id="inshop_tibbe_car_key_price" name="inshop_tibbe_car_key_price" value="<?php if(isset($inshop_tibbe_car_key_price) && !empty($inshop_tibbe_car_key_price)){ echo $inshop_tibbe_car_key_price; } ?>" class="form-control">
						</div>
					</div>

					<div class="form-group">
						<label class="control-label col-sm-3 col-md-3" for="inshop_vats_car_key_cut_price"><?php echo __( 'In-Shop VATS Car Key Cutting Price ('.get_woocommerce_currency_symbol().')', 'woocommerce-bookings' ); ?></label>
						<div class="col-md-6 col-sm-9">
							<input type="number" min="0" step="1" id="inshop_vats_car_key_cut_price" name="inshop_vats_car_key_cut_price" value="<?php if(isset($inshop_vats_car_key_cut_price) && !empty($inshop_vats_car_key_cut_price)){ echo $inshop_vats_car_key_cut_price; } ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3 col-md-3" for="inshop_car_key_programmed_price"><?php echo __( 'In-Shop Car Key Programming Price ('.get_woocommerce_currency_symbol().')', 'woocommerce-bookings' ); ?></label>
						<div class="col-md-6 col-sm-9">
							<input type="number" min="0" step="1" id="inshop_car_key_programmed_price" name="inshop_car_key_programmed_price" value="<?php if(isset($inshop_car_key_programmed_price) && !empty($inshop_car_key_programmed_price)){ echo $inshop_car_key_programmed_price; } ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3 col-md-3" for="inshop_vats_car_key_programmed_price"><?php echo __( 'In-Shop VATS Car Key Programming Price ('.get_woocommerce_currency_symbol().')', 'woocommerce-bookings' ); ?></label>
						<div class="col-md-6 col-sm-9">
							<input type="number" min="0" step="1" id="inshop_vats_car_key_programmed_price" name="inshop_vats_car_key_programmed_price" value="<?php if(isset($inshop_vats_car_key_programmed_price) && !empty($inshop_vats_car_key_programmed_price)){ echo $inshop_vats_car_key_programmed_price; } ?>" class="form-control">
						</div>
					</div>
...
jQuery(document).ready(function(){
	...
	jQuery(document).on('click','#mobile_locksmith',function(){
		if(jQuery("#mobile_locksmith").prop('checked') == true){
			...
			jQuery("#_wc_booking_in_shop_pricing_cost").attr('disabled','disabled');
			jQuery("#_wc_in_shop_key_duplication_price_cost").attr('disabled','disabled');
		}
		else
		{ 
			jQuery("#mobile_locksmith_address").val('');
			jQuery("#mob_lock_service_area").addClass('disabled');
			jQuery("#_wc_booking_in_shop_pricing_cost").removeAttr("disabled");
			jQuery("#_wc_in_shop_key_duplication_price_cost").removeAttr("disabled");
	...
	function check_vats_car(){
		if(jQuery("#works_on_vats_car").prop('checked') == true){
			...
			jQuery("#inshop_vats_car_key_cut_price").val(0);
			jQuery("#inshop_vats_car_key_cut_price").attr('disabled','disabled');
			jQuery("#inshop_vats_car_key_programmed_price").val(0);
			jQuery("#inshop_vats_car_key_programmed_price").attr('disabled','disabled');
		}
		else{
			...
			jQuery("#inshop_vats_car_key_cut_price").val('');
			jQuery("#inshop_vats_car_key_cut_price").removeAttr("disabled");
			jQuery("#inshop_vats_car_key_programmed_price").val();
			jQuery("#inshop_vats_car_key_programmed_price").removeAttr("disabled");
		}
	}
});
</script>
