...
?>
<div role="tabpanel" class="tab-pane fade aaaa" id="<?php esc_attr_e( $tab ); ?>">
    <div class="row-padding">
        <div class="form-group-row"> 
            <div class="form-group">
                <label class="control-label col-sm-3 col-md-3" for="_wc_booking_cost"><?php echo __( 'Base Service Price', 'woocommerce-bookings' ) . ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
            ...
            <div class="form-group">
                <label class="control-label col-sm-3 col-md-3" for="_wc_booking_block_cost"><?php echo __( 'Labor Price', 'woocommerce-bookings' ) . ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
                <div class="col-md-6 col-sm-9">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3 col-md-3" for="_wc_display_cost"><?php echo __( 'Starting At Price', 'woocommerce-bookings' ) . ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
                <div class="col-md-6 col-sm-9">
