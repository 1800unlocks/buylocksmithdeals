...
.product-filter-actions .alignleft.actions {
display: flex;
margin-top: 15px;
margin-bottom: 10px;
}
body .product-filter-actions .select2-container {    
margin-right: 10px;
}
.product-filter-actions select#product_types {
margin-right: 10px;
}
...
//                    endif;
        ...
        $products_table_headers =     array_slice($products_table_headers, 0, 7, true) +
    array("status_vendor" => "Status") +
    array_slice($products_table_headers, 7, count($products_table_headers)-7, true);
...
//                }
            ...
            "ajax": {
                url: '<?php echo add_query_arg( 'action', 'wcmp_vendor_product_list_wnw', $WCMp->ajax_url() ); ?>',
                type: "post",
                data: function (data) {
