...
if ($vendor) {
    ...
    $html .= '<h2 class="TEST">' . $vendor->page_title . '</h2>';
    echo $html;
    ...
    $html .= '<p><a href="' . $vendor->permalink . '">' . sprintf(__('More Deals from %1$s', 'dc-woocommerce-multi-vendor'), $vendor->page_title) . '</a></p>';
