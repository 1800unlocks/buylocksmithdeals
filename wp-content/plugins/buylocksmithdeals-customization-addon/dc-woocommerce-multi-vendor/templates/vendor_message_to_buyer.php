...
<table style="width:100%; color: #737373; border: 1px solid #e4e4e4; background:none;" border="0" cellpadding="8" cellspacing="0">
    <tbody>
        ...
        <?php if ($cc == 0) { ?>
                    <tr>
                        <th style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:50%;" align="left" valign="top"><?php echo __('Locksmith Details', 'dc-woocommerce-multi-vendor'); ?></th>
        ...
        <?php } ?>
                <tr>
                    <td style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:50%;" align="left" valign="top">
                        <p><strong><?php echo __('Locksmith Name', 'dc-woocommerce-multi-vendor'); ?> </strong><br>
                            <?php echo $vendor->page_title; ?> </p>
                        <p><strong><?php echo __('Deal Name', 'dc-woocommerce-multi-vendor'); ?> </strong> <br>
                        <?php echo $products; ?>
                        </p>
                        <?php
