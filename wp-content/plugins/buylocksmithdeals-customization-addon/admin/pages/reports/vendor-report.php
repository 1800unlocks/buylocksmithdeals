...
<div class="wrap">
    <div class="container">
        ...
        <div class="inner_area">
         <?php
          require_once 'model/vendor-list.php';
//Prepare Table of elements
$wp_list_table = new Vendor_List_Table();
         ?>
            
                 <div id="post-body-content client_list_table nuj4_custom_admin_list_table">
                    
                        <form method="post" action="<?php echo home_url();?>/wp-admin/admin.php?page=blsm-vendor-reports">
