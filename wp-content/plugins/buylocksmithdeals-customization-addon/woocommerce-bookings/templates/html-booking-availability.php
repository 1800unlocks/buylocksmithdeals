...
$productid=$bookable_product->get_id();
...
<div id="bookings_availability" class="panel woocommerce_options_panel">
	<div class="options_group">
		...
		<p class="form-field _wc_booking_last_block_time_field">
			<label for="_wc_booking_last_block_time"><?php esc_html_e( 'Last block ends at...', 'woocommerce-bookings' ); ?></label>
			<input type="time" name="_wc_booking_last_block_time" id="_wc_booking_last_block_time" value="<?php echo $wc_booking_last_block_time; ?>" placeholder="HH:MM" />
		</p>
