<div id="bookings_pricing" class="panel woocommerce_options_panel ">
	<div class="options_group">
		...
		woocommerce_wp_text_input( array(
			'id'                => '_wc_booking_cost',
			'label'             => __( 'Base Service Price', 'woocommerce-bookings' ),
		...
		woocommerce_wp_text_input( array(
			...
			'label'             => __( 'Labor Price', 'woocommerce-bookings' ),
		...
		woocommerce_wp_text_input( array(
			'id'                => '_wc_display_cost',
			'label'             => __( 'Starting At Price', 'woocommerce-bookings' ),
				...
				<tfoot>
					<tr>
						<th colspan="9">
							...
							ob_start();
                                                         include WC_BOOKINGS_ABSPATH.'includes/admin/views/html-booking-pricing-fields.php';
