...
final class BuyLockSmithDealsCustomizationAjax {
        ...
        if (empty($review)) {
            ...
            if ($current_user->ID > 0) {
                ...
                if (!is_wp_error($comment_id)) {
                    ...
                    $subject = __("Recommend Locksmith to others ", 'theme_name');
                    $attachments=[];
    ...
    public function blsd_get_car_model_year(){
        ...
        $all_cars= BuyLockSmithDealsCustomizationAddon::get_all_cars_frontend($vendor_unserviceable_cars,$field,$where_field);
