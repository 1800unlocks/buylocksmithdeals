   ...
   function blsd_add_js_frontend(){
    ...
    function blsd_frontend_before_add_to_cart_btn() {
        ...
        if ($quantity_of_locks == 'yes') {
            ...
            $option = '<option value="">Choose Quantity of keys to make</option>';
            for ($i = 1; $i <= 99; $i++) {
                $option .= '<option value="' . $i . '" >' . $i . '</option>';
            }
       ...
       <script>
                ...
                setTimeout(function () {
                    ...
                    if (booking_price != 0) {
                        ...
                        if (element.classList.contains("property")) {
                            ...
                            var total_service_booking_amount = parseFloat(amount + total + booking_price +car_key_price + key_cost +extra_cylinder_price+car_programming_fees + deadbolt_install_price + extra_deadbolt_cylinder_price+extra_house_key_price);
                            ...
                            var total_service_booking = parseFloat(amount + total + booking_price + car_key_price + key_cost +extra_cylinder_price + car_programming_fees + deadbolt_install_price +extra_deadbolt_cylinder_price + extra_house_key_price + tax);
            ...
            jQuery('.wc-pao-addon-select option:contains("None")').text('Choose service location');
				...
				jQuery('#quantity_locks_to_install').change(function(){
                    var quantity_locks_to_install=parseInt(jQuery('#quantity_locks_to_install').val());
					
                    var included_deadbolt_cylinders='<?php echo $deadbolt_cylinders_included; ?>';
                    var extra_per_deadbolt_cylinders_price='<?php echo $extra_per_deadbolt_cylinders_included_price; ?>';
                    if(included_deadbolt_cylinders < quantity_locks_to_install){
                        var extra_deadbolt_cylinders=parseInt(quantity_locks_to_install - included_deadbolt_cylinders);
                        var extra_deadbolt_cylinders_price=parseInt(extra_deadbolt_cylinders*extra_per_deadbolt_cylinders_price);
                        console.log('extra_deadbolt_cylinders', extra_deadbolt_cylinders);
                        console.log('extra_deadbolt_cylinders_price', extra_deadbolt_cylinders_price);
                        
                        calculate_final_deadbolt_amount(extra_deadbolt_cylinders,extra_per_deadbolt_cylinders_price);
				...
				function calculate_house_key_final_amount(extra_house_keys,extra_per_house_key_price){
                    ...
                    if (element.classList.contains("property")) {
                        ...
                        console.log(amount, total, service_location_price, booking_price, booking_price_with_tax,extra_house_key_price);
                        var total_amount = parseFloat(total + service_location_price);
                        if(service_location_price >0){
                          var total_service_booking_amount = parseFloat( total + service_location_price + booking_price+extra_house_key_price);
                          console.log('total_service_booking_amount',total_service_booking_amount);
                            if (booking_price_with_tax === '') {
                                var tax=0;
                            } else {
                           ...
                           var total_service_booking_amount = parseFloat(booking_price+extra_house_key_price);
                           var total_service_booking = parseFloat(booking_price +extra_house_key_price);
                        }
                ...
                jQuery('.wc-pao-addon-select').change(function () {
                    ...
                    if (service_location_price > 0 && service_location_val != '') {
                       ...
                       var total = 0;
                        ...
                        var total_service_booking_amount = parseFloat(amount + total + service_location_price + booking_price + car_key_price + key_cost + extra_cylinder_price + car_programming_fees + deadbolt_install_price + extra_deadbolt_cylinder_price + extra_house_key_price);
                        console.log('total_service_booking_amount',total_service_booking_amount);
                        if (booking_price_with_tax == '') {
                            var tax=0;
                        } else {
                        ...
                        var total_service_booking = parseFloat(amount + total + service_location_price + booking_price + car_key_price +key_cost +extra_cylinder_price +car_programming_fees + deadbolt_install_price + extra_deadbolt_cylinder_price +extra_house_key_price +tax);
                       ...
                       // jQuery('#map_display').removeClass('property');
                        ...
                        if (Number.isNaN(extra_house_key_price)) {
                         ...
                         total_service_booking=parseFloat(total_service_booking+extra_cylinder_price+car_key_price+key_cost+car_programming_fees+deadbolt_install_price+ extra_deadbolt_cylinder_price+ extra_house_key_price);
