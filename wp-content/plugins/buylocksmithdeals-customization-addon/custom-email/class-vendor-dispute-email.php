 ...
 *
 */
class Blsd_Vendor_Dispute_Email extends WC_Email {
    
    function __construct() {
        
        // Add email ID, title, description, heading, subject
        $this->id                   = 'blsd_vndor_dispute_email';
        $this->title                = __( 'Blsd Vendor Dispute Email', 'blsd-custom-email' );
        $this->description          = __( 'This email is received when an order status is changed to Pending.', 'blsd-custom-email' );
        
        $this->heading              = __( 'Blsd Vendor Dispute Email', 'blsd-custom-email' );
        $this->subject              = __( 'New Dispute', 'blsd-custom-email' );
        
        // email template path
        $this->template_html    = 'emails/custom-blsd-dispute-email.php';
        $this->template_plain   = 'emails/plain/custom-blsd-dispute-email.php';
        
        // Triggers for this email
        add_action( 'vendor_dispute_email_notification', array( $this, 'trigger' ) );
...
return new Blsd_Vendor_Dispute_Email();
?>