<div class="wcmp_form1">
    <div class="col-md-12 add-product-wrapper">
        ...
        <div class="product-primary-info custom-panel"> 
            ...
            $query = "SELECT $table_name.*,$table_name_message_table.title,$table_name_status.name as status_name, $table_name_message_table.message as message ,$table_name_message_table.username as username ,$table_name_message_table.phone_number as phone_number ,$table_name_message_table.email as email ,$table_name_message_table.order_number as order_number"
                    ...
                    . " WHERE (user_id=$vendor_id or who_opose_user_id=$vendor_id) and $table_name.id = $id";
                ...
                $results = (array) $wpdb->get_results($wpdb->prepare($query, $type), ARRAY_A);
                    ...
                    if ($message != '') {
						if($message == 'Something Else'){
							$message = $_REQUEST['something_else_message'];
						}
                    ...
                    <div class="dispute_detail_area">
                        <div class="form-group-row"> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3" for="title"><?php echo __('Name', 'woocommerce'); ?></label>
                                <div class="col-md-6 col-sm-9 dispute_show_field">
                                    <?php echo $data['username']; ?>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="control-label col-sm-3 col-md-3" for="title"><?php echo __('Email', 'woocommerce'); ?></label>
                                <div class="col-md-6 col-sm-9 dispute_show_field">
                                    <?php echo $data['email']; ?>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="control-label col-sm-3 col-md-3" for="title"><?php echo __('Phone Number', 'woocommerce'); ?></label>
                                <div class="col-md-6 col-sm-9 dispute_show_field">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 dispute_show_field">
