            ...
            <?php 
                ...
                <form method="post" id="add_dispute" enctype="multipart/form-data">
                    ...
                    <div class="form-group-row pricing"> 
						...
						<div class="form-group">
                            <label class="control-label col-sm-3 col-md-3" for="name"><?php echo __('Name', 'woocommerce'); ?></label>
                            <div class="col-md-6 col-sm-9">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-9">
                                <input type="text" id="order_number" name="order_number" value="" class="form-control">
                            </div>
                        </div> 
						<div class="form-group">
