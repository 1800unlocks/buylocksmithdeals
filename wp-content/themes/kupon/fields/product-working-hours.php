            ...
            foreach ($days as $day => $day_name) {
                ...
                <tr>
                    ...
                    if (empty($working_hours['open-' . $day]) || empty($working_hours['close-' . $day])) {
                        ...
                        <td class="open">
                            <?php
                            print date_i18n(get_option('time_format'), strtotime(esc_html($working_hours['open-' . $day])));
                            ?>
                        </td>
                        <td class="close">
                            <?php
                            print date_i18n(get_option('time_format'), strtotime(esc_html($working_hours['close-' . $day])));
                            ?>
                        </td>
                        <?php
                    }
