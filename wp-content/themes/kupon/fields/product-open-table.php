        ...
        <form method="get" class="azot-form" action="//www.opentable.com/restaurant-search.aspx" target="_blank">
            <div class="azot-wrapper">
                <div class="azot-date-wrap">
                    <label for="date-<?php print esc_attr($post->ID); ?>"><?php esc_html_e('Date', 'AZEXO');?></label>
                    <input id="date-<?php print esc_attr($post->ID); ?>" name="startDate" class="azot-reservation-date" type="text" value="" placeholder="<?php esc_attr_e('Date', 'AZEXO');?>" readonly="readonly">
                </div>
                <div class="azot-time-wrap">
                    <label for="time-<?php print esc_attr($post->ID); ?>"><?php esc_html_e('Time', 'AZEXO');?></label>
                ...
                <div class="azot-party-size-wrap">
                    <label for="party-<?php print esc_attr($post->ID); ?>"><?php esc_html_e('Party Size', 'AZEXO'); ?></label>
                    <select id="party-<?php print esc_attr($post->ID); ?>" name="partySize" class="azot-party-size-select">
                        <option value="1">1 <?php esc_html_e('Person', 'AZEXO'); ?></option>
                        <option value="2" selected="selected">2 People</option>
                        <option value="3">3 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="4">4 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="5">5 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="6">6 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="7">7 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="8">8 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="9">9 <?php esc_html_e('People', 'AZEXO'); ?></option>
                        <option value="10">10 <?php esc_html_e('People', 'AZEXO'); ?></option>
                    </select>

                </div>

                <div class="azot-button-wrap">
                    <input type="submit" class="" value="<?php esc_html_e('Find a Table', 'AZEXO'); ?>" />
                </div>
