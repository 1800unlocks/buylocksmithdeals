...
class AZEXO_Import {
    ...
    function import_content($file = 'content.xml') {
        ...
        if (file_exists($xml)) {
            ...
            //$this->error = esc_html__('File which need for import does not exist.', 'AZEXO');
        }
    }
            ...
            if (wp_verify_nonce($_POST['azexo_import_nonce'], 'azexo_import_nonce')) {
                ...
                if (class_exists('WP_Import')) {
                    ...
                    switch ($_POST['import']) {
                        ...
                        default:
                            $this->error = esc_html__('Please select data to import.', 'AZEXO');
                            break;
                    }
                    ...
                    if (isset($this->error)) {
                        ...
                        echo '<p><strong>' . esc_html__('All done. Have fun!', 'AZEXO') . '</strong></p>';
                        echo '</div>';
                    }
                } else {
                    echo '<div class="error settings-error">';
                    echo '<p><strong>' . esc_html__('Please activate WordPress Importer plugin', 'AZEXO') . '</strong></p>';
                    echo '</div>';
                }
            }
        }
        ...
        <div id="azexo-wrapper" class="azexo-import wrap">
            ...
            <form action="" method="post">
                ...
                <table class="form-table">
                    ...
                    <tr class="row-import">
                        <th scope="row">
                            <label for="import"><?php esc_html_e('Import', 'AZEXO'); ?></label>
                        </th>
                        <td>
                            <select name="import" class="import">
                                <option value="demo" selected><?php esc_html_e('Demo - new site', 'AZEXO'); ?></option>
                                <option value="configuration"><?php esc_html_e('Theme Options - existing site', 'AZEXO'); ?></option>
                                <option value="pages"><?php esc_html_e('Pages - existing site', 'AZEXO'); ?></option>
                                <option value="azh_widgets"><?php esc_html_e('AZH/VC widgets - existing site', 'AZEXO'); ?></option>
                                <option value="taxonomies"><?php esc_html_e('Taxonomies - existing site', 'AZEXO'); ?></option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr class="row-demo hide">
                        <th scope="row">
                            <label for="demo"><?php esc_html_e('Demo', 'AZEXO'); ?></label>
                        </th>
                        <td>
                            <select name="demo">
                                <?php
                    ...
                    <tr class="row-attachments hide">
                        <th scope="row"><?php esc_html_e('Attachments', 'AZEXO'); ?></th>
                        <td>
                            <fieldset>
                                <label for="attachments"><input type="checkbox" value="1" id="attachments" name="attachments"><?php esc_html_e('Import attachments', 'AZEXO'); ?></label>
                                <p class="description"><?php esc_html_e('Download all attachments from the demo may take a while. Please be patient.', 'AZEXO'); ?></p>
                            </fieldset>
                        </td>
                    </tr>

                    <tr class="row-clear-wp hide">
                        <th scope="row"><?php esc_html_e('Clear WP', 'AZEXO'); ?></th>
                        <td>
                            <fieldset>
                                <label for="clear-wp"><input type="checkbox" value="1" id="clear-wp" name="clear-wp"><?php esc_html_e('Clear WP database before import content', 'AZEXO'); ?></label>
                                <p class="description"><?php esc_html_e('Remove all posts, pages, comments, taxonomies, custom posts types and correspond meta data.', 'AZEXO'); ?></p>
                            </fieldset>
                        </td>
                    </tr>
                ...
                <input type="submit" name="submit" class="button button-primary" value="<?php esc_attr_e('Import data', 'AZEXO'); ?>" />
